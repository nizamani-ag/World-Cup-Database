...
then
  if [[ $YEAR != "year" ]]
  then
    in_games=$($PSQL "INSERT INTO games(year,round,winner_id,opponent_id,winner_goals,opponent_goals) VALUES($YEAR,'$ROUND',$team_id_w,$team_id_o,$WINNER_G,$OPPONENT_G)")
